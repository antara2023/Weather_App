...
function renderWeatherData(weatherData) {
    ...
    imgRef.src = "https:"+weatherData.current.condition.icon;
}
...
function fetchWeatherData(location) {
    fetch('https://api.weatherapi.com/v1/current.json?key=35af7ff606db422880d141328231305&q='+location) 
        .then((res) => res.json()) //doubt 
        // .then((data) => console.log('success', data)) 
        .then((data) => renderWeatherData(data)) //doubt 
